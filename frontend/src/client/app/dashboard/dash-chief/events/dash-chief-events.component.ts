...
@Component({
    moduleId: module.id,
    selector: 'sd-dashboard-chief-events',
    templateUrl: 'dash-chief-events.component.html',
    styleUrls: ['dash-chief-events.component.css'],
})


export class DashChiefEventsComponent implements OnInit {

    currentUser:User = new User();
    selectedPanel:string = GlobalSettings.ROUTE_DASHBOARD_CHIEF_EVENTS;

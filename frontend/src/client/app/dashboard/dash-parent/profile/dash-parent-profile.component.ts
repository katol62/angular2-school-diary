...
@Component({
    moduleId: module.id,
    selector: 'sd-dashboard-parent-profile',
    templateUrl: 'dash-parent-profile.component.html',
    styleUrls: ['dash-parent-profile.component.css'],
})


export class DashParentProfileComponent implements OnInit {

    currentUser:User = new User();
    selectedPanel:string = GlobalSettings.ROUTE_DASHBOARD_PARENT_PROFILE;
